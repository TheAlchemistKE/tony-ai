...
export default function CodePage() {
  ...
  return (
    <div>
        <Heading title='Code Generation' description='Meet you pair programmer. Generate code with descriptive text.'
        icon={MessageSquare}
        ...
        <div className='px-4 lg:px-8'>
                            ...
                            <FormItem className='col-span-12 lg:col-span-10'>
                                <FormControl className='m-0 p-0'>
                                    <Input
                                        ...
                                        disabled={isLoading}
                                        placeholder='Show me how to reverse a LinkedList in TypeScript...'
                                        {...field}/>
                                </FormControl>
                            </FormItem>
                        )}/>
            ...
            <div className='space-y-4 mt-4'>
                ...
                {messages.length === 0 && !isLoading && (
                    <Empty label='No Previous Conversations'/>
                )}
